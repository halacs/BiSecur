...
const (
	...
	COMMANDID_ADD_PORT          = 0x29
	COMMANDID_GET_PORTS         = 0x30
	COMMANDID_GET_TYPE          = 0x31
	COMMANDID_INHERIT_PORT      = 0x41
	COMMANDID_REMOVE_PORT       = 0x42
	...
	COMMANDID_ADD_PORT_RESPONSE          = COMMANDID_ADD_PORT | RESPONSE_MASK
	COMMANDID_GET_PORTS_RESPONSE         = COMMANDID_GET_PORTS | RESPONSE_MASK
	COMMANDID_GET_TYPE_RESPONSE          = COMMANDID_GET_TYPE | RESPONSE_MASK
	COMMANDID_INHERIT_PORT_RESPONSE      = COMMANDID_INHERIT_PORT | RESPONSE_MASK
	COMMANDID_REMOVE_PORT_RESPONSE       = COMMANDID_REMOVE_PORT | RESPONSE_MASK
